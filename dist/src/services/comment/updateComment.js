...
var updateCommentService = function (_a) {
    var description = _a.description, commentId = _a.commentId;
    return __awaiter(void 0, void 0, void 0, function () {
        var comment, updatedItem;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!commentId)
                        throw new Error('commentId not transferred');
                    return [4 /*yield*/, (0, connectToDB_1.connectToDB)()];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, model_1.Comment.findById(commentId)];
                case 2:
                    comment = _b.sent();
                    if (!comment)
                        throw new Error('commentId not exist');
                    return [4 /*yield*/, model_1.Comment.findByIdAndUpdate(commentId, {
