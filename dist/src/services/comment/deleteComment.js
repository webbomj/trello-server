...
var deleteCommentService = function (itemId, commentId) { return __awaiter(void 0, void 0, void 0, function () {
    var item, comment;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!commentId || !itemId)
                    throw new Error('commentId or itemId not transferred');
                return [4 /*yield*/, (0, connectToDB_1.connectToDB)()];
            case 1:
                _a.sent();
                return [4 /*yield*/, model_1.Item.findOneAndUpdate({ _id: itemId }, { $pull: { comments: commentId } })];
            case 2:
                item = _a.sent();
                if (!item)
                    throw new Error('itemId does not exist');
                return [4 /*yield*/, model_1.Comment.findByIdAndDelete(commentId)];
            case 3:
                comment = _a.sent();
                if (!comment)
