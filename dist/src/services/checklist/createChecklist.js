...
var createChecklist_1 = require("../../utils/createChecklist");
var createChecklistService = function (_a) {
    var itemId = _a.itemId, title = _a.title;
    return __awaiter(void 0, void 0, void 0, function () {
        var newChecklist, item, checklist;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!itemId || !title)
                        throw new Error('title or itemId not transferred');
                    return [4 /*yield*/, (0, connectToDB_1.connectToDB)()];
                case 1:
                    _b.sent();
                    newChecklist = (0, createChecklist_1.createChecklist)(title);
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, model_1.CheckList.create(newChecklist)];
                case 4:
                    checklist = _b.sent();
