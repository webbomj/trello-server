...
var updateWorkSpaceService = function (workSpaceId, title) { return __awaiter(void 0, void 0, void 0, function () {
    var workspace, newWorkSpace;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!workSpaceId || !title)
                    throw new Error('workSpaceId or title not transferred');
                return [4 /*yield*/, (0, connectToDB_1.connectToDB)()];
            case 1:
                _a.sent();
                return [4 /*yield*/, model_1.WorkSpace.findByIdAndUpdate(workSpaceId, { title: title })];
            case 2:
                workspace = _a.sent();
                if (!workspace)
            ...
            case 3:
                newWorkSpace = _a.sent();
                return [2 /*return*/, newWorkSpace];
        }
    });
}); };
