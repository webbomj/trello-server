...
var deleteItemService = function (listId, itemId) { return __awaiter(void 0, void 0, void 0, function () {
    var list, item;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!listId || !itemId)
                    throw new Error('listId or itemId not transferred');
                return [4 /*yield*/, (0, connectToDB_1.connectToDB)()];
            case 1:
                _a.sent();
                return [4 /*yield*/, model_1.List.findOneAndUpdate({ _id: listId }, { $pull: { items: itemId } })];
            case 2:
                list = _a.sent();
                if (!list)
                    throw new Error('listId does not exist');
                return [4 /*yield*/, model_1.Item.findByIdAndDelete(itemId)];
            case 3:
                item = _a.sent();
                if (!item)
