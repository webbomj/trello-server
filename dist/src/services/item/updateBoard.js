...
var updateBoardService = function (_a) {
    var title = _a.title, color = _a.color, image = _a.image, boardId = _a.boardId;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!boardId)
                        throw new Error('boardId not transferred').message;
                ...
                case 2:
                    board = _b.sent();
                    if (!board)
                        throw new Error('boardId not exist').message;
