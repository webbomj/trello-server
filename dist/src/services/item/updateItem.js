...
var updateItemService = function (_a) {
    var title = _a.title, description = _a.description, deadline = _a.deadline, image = _a.image, itemId = _a.itemId;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, model_1.Item.findByIdAndUpdate(itemId, {
