...
var createList_1 = require("../../utils/createList");
var createListService = function (_a) {
    var boardId = _a.boardId, title = _a.title;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!boardId || !title)
                        throw new Error('boardId or title is undefined');
                    return [4 /*yield*/, (0, connectToDB_1.connectToDB)()];
                case 1:
                    _b.sent();
                    newList = (0, createList_1.createList)(title);
                    return [4 /*yield*/, model_1.Board.findById(boardId)];
                case 2:
                    board = _b.sent();
                    if (!board)
                        throw new Error('boardId is not found');
                    board.lists.push(newList._id);
                    return [4 /*yield*/, board.save()];
                case 3:
                    _b.sent();
                    return [4 /*yield*/, model_1.List.create(newList)];
                case 4:
                    list = _b.sent();
